    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white rounded-2xl p-6 animate-fade-in">
        ...
        <div className="space-y-3">
          ...
          {/* Divider or direct email form */}
          {googleAvailable && !showEmailForm ? (
            <>
              ...
              <button
                ...
                className="w-full py-2.5 border border-[var(--border)] rounded-xl font-medium text-sm hover:bg-gray-50 transition-colors"
              >
                Continue with email
              </button>
            </>
